#!/usr/bin/python
# Python erroneously reads in flybase multi-fasta files with newline within sequence. Not good!
# Useful for correcting fasta file with newline separating nucleotides of the same sequence
